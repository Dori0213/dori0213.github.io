...
function foldrajzi(adatok){
    //console.log(adatok);
    document.getElementById("felirat4").innerHTML= '<p class="lila">Földrajzi hosszúság: ' + adatok.longitude+'</p>';
}
//--------------------------------------------------------
...
function arfolyam1(adatok){
    console.log(adatok);
    document.getElementById('felirat3').innerHTML='<p class="zold">1 EUR = ' + adatok.rates.HUF+' HUF (Ft)</p>';
}
